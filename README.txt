...
once the dependencies are installed. install.sh uses uv if it is on your PATH
and otherwise python3 -m venv; on Debian or Ubuntu without uv, install the
python3-venv package first. Timings and resource use are in
